    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-gray-900 rounded-2xl p-8 border border-gray-800 space-y-6">
        ...
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold mt-2 text-white">ResumeAI Analyser</h1>
        ...
        <button
          ...
          className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50
                     rounded-xl py-3 font-semibold flex items-center justify-center gap-2 transition text-white"
        >
          {loading
